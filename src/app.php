...
print_r([
    "São Paulo" => $calculaJuros->valorCobrado($valor, $sp),
    "Santa Catarina" => $calculaJuros->valorCobrado($valor, $sc),
    "Bahia" => $calculaJuros->valorCobrado($valor, $ba),
    "Bahia Sul" => $calculaJuros->valorCobrado($valor, $baSul),
    "Bahia Norte" => $calculaJuros->valorCobrado($valor, $baNorte),
    "Minas Gerais" => $calculaJuros->valorCobrado($valor, $mg),
    "Minas Gerais Nordeste" => $calculaJuros->valorCobrado($valor, $mgNordeste),
]);